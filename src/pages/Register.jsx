      ...
      <div className='flex md:flex-row flex-col'>
        <div className='bg-primary md:rounded-none rounded-bl-[20px] rounded-br-[20px] overflow-hidden flex-[1] flex relative h-[100dvh]'>
          <div className='p-5 md:space-y-3 relative z-10'>
            <div className='md:text-[55px] text-white text-[30px] md:leading-[60px] leading-[40px] font-[700]'>True crypto ownership.
            Powerful Web3 experiences</div>
            <div className="text-white text-opacity-90 md:text-[16px] text-[14px] mt-4">Unlock the power of your cryptocurrency assets and explore the world of Web3 with Trust Wallet.</div>
          </div>
          <img src="https://trustwallet.com/_next/static/media/raw.0acff7b3.svg" className='absolute md:bottom-[-90px] md:w-[500px] md:flex hidden w-[200px] right-0' alt="" />
        </div>

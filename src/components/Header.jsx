...
const Header = () => {
  ...
  return (
    <header className='w-full bg-white md:hidden block'>
        <div className='flex justify-between items-center md:w-[95%] m-auto px-3 md:py-6 py-3'>
            <div className='flex-[2] relative'>
                ...
                <div className='absolute md:text-[10px] text-[8px] px-3 text-black bg-white rounded-full font-[800] md:bottom-[3px] bottom-[5px] md:right-[17rem] right-[7rem] shadow-md'>RECOVERY</div>
            </div>
            ...
            <div className='flex items-center justify-end flex-[2] gap-4'>
                {/* <Button 
                    type={'outline'}
                    iconName={<MdLanguage />}
                    text={"Language"}
